    ...
    ";
      ...
      <span class=\"sr-only\">
        ...
        <span class=\"file-size\">";
            // line 30
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, (isset($context["file_size"]) ? $context["file_size"] : null), "html", null, true));
            echo "</span>
      </span>
    ";
        } else {
...
";
    ...
    {
        return new Twig_Source("", "themes/bootstrap/templates/file/file-link.html.twig", "/services/http/users/v/vrab/decal/themes/bootstrap/templates/file/file-link.html.twig");
    }
}
