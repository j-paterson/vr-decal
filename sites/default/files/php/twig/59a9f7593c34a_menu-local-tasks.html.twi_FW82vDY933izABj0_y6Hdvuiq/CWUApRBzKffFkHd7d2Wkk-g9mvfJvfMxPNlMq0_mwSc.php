...
";
    ...
    {
        return new Twig_Source("", "themes/bootstrap/templates/menu/menu-local-tasks.html.twig", "/services/http/users/v/vrab/decal/themes/bootstrap/templates/menu/menu-local-tasks.html.twig");
    }
}
